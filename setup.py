...
setuptools.setup(
    ...
    description="Simulator for the LSST auxiliary telescope motor control system",
    use_scm_version={
    ...
    scripts=["bin/run_atmcs_simulator.py"],
    tests_require=tests_require,
    extras_require={"dev": dev_requires},
    license="GPL",
    project_urls={
        "Bug Tracker": "https://jira.lsstcorp.org/secure/Dashboard.jspa",
        "Source Code": "https://github.com/lsst-ts/ts_ATMCSSimulator",
    },
)
